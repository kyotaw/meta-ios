...
internal class MurmurResource : Resource {
    ...
    static func getMono(model: String, modelId: String, vendor: String, callback: @escaping MurmurCallback) {
    ...
    static func registerMono(model: String, modelId: String, vendor: String, name: String, callback: @escaping MurmurCallback) {
        let endPoint = [Resource.url, "monos"].joined(separator: "/")
        let params = [
            "model": model,
            "modelId": modelId,
